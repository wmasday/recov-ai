...
<body class="bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        ...
                        <span class="text-secondary subwelcome">Hola {{ Auth::user()->name }}</span>
                    </li>
                </ul>
    ...
    <div class="offcanvas offcanvas-start sidebar border-end" data-bs-scroll="true" data-bs-backdrop="false"
        ...
        <div class="offcanvas-body">
            ...
            <a class="menu-list" href="{{ route('logout') }}" style="margin-top: 200px !important;">
                <div class="icon float-start">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#ED6C3C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
